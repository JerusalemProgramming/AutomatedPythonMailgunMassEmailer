...
<li>Developed, integrated, and implemented data ingestion pipelines to extract, clean, normalize, and store company/contact information from large CSV files into a structured SQLite database of over 17980 contacts/companies (i.e. unique e-mails).</li>
